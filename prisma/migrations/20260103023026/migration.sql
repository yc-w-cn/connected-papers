/*
  ...
  - You are about to drop the column `processedAt` on the `ArxivPaper` table. All the data in the column will be lost.
  - You are about to drop the column `referencesFetched` on the `ArxivPaper` table. All the data in the column will be lost.
...
INSERT INTO "new_ArxivPaper" ("abstract", "arxivId", "arxivUrl", "comment", "createdAt", "doi", "id", "journalRef", "license", "primaryCategory", "publishedDate", "status", "title", "updatedAt", "updatedAtArxiv") SELECT "abstract", "arxivId", "arxivUrl", "comment", "createdAt", "doi", "id", "journalRef", "license", "primaryCategory", "publishedDate", "status", "title", "updatedAt", "updatedAtArxiv" FROM "ArxivPaper";
