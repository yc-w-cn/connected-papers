...
export async function saveCitationSemanticScholarData(arxivPaperId: string, cit: ArxivCitation) {
  if (!cit.paperId) {
...
export async function createCitationRelation(citingPaperId: string, citedPaperId: string) {
