...
export const mockSuccessResponse = createMockResponse(true, 200, '', null, []);
...
export const mockErrorResponse = createMockResponse(false, 500, '', null, []);
